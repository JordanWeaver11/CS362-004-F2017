...
//Smithy
int actSmithy(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int* i, int* j, int* k, int* x, int* index, int* currentPlayer, int* nextPlayer, int* tributeRevealedCards, int* temphand, int* drawntreasure, int* cardDrawn, int* z)
{
      //+3 Cards
      for (*i = 0; *i < 3; *i++)
	{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case smithy:
		actSmithy(card, choice1, choice2, choice3, state, handPos, bonus, &i, &j, &k, &x, &index, &currentPlayer, &nextPlayer, tributeRevealedCards, temphand, &drawntreasure, &cardDrawn, &z);
